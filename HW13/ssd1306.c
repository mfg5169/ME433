...
void ssd1306_setup() {
    ...
    printf("SSD1306 Display Off\n");
    ssd1306_command(SSD1306_SETDISPLAYCLOCKDIV);
    ssd1306_command(0x80);
    printf("SSD1306 Set Display Clock Div\n");
    ssd1306_command(SSD1306_SETMULTIPLEX);
    ssd1306_command(0x1F); // height-1 = 31
    printf("SSD1306 Set Multiplex\n");
    ssd1306_command(SSD1306_SETDISPLAYOFFSET);
    ssd1306_command(0x0);
    printf("SSD1306 Set Display Offset\n");
    ssd1306_command(SSD1306_SETSTARTLINE);
    printf("SSD1306 Set Start Line\n");
    ssd1306_command(SSD1306_CHARGEPUMP);
    ssd1306_command(0x14);
    printf("SSD1306 Charge Pump\n");
    ssd1306_command(SSD1306_MEMORYMODE);
    ssd1306_command(0x00);
    printf("SSD1306 Set Memory Mode\n");
    ssd1306_command(SSD1306_SEGREMAP | 0x1);
    ssd1306_command(SSD1306_COMSCANDEC);
    printf("SSD1306 Set Segment Remap and COM Scan Direction\n");
    ssd1306_command(SSD1306_SETCOMPINS);
    ssd1306_command(0x02);
    ssd1306_command(SSD1306_SETCONTRAST);
    printf("SSD1306 Set Contrast\n");
    ssd1306_command(0x8F);
    ssd1306_command(SSD1306_SETPRECHARGE);
    ssd1306_command(0xF1);
    ssd1306_command(SSD1306_SETVCOMDETECT);
    printf("SSD1306 Set VCOM Detect\n");
...
void ssd1306_command(unsigned char c) {
    ...
    buf[0] = 0x00;
    buf[1] =c;
    i2c_write_blocking(I2CLED_PORT, SSD1306_ADDRESS, buf, 2, false);
}
...
void ssd1306_update() {
    ...
    */
    ...
    i2c_write_blocking(I2CLED_PORT, SSD1306_ADDRESS, ptr, 513, false);
}
